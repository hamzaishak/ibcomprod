...
// var DEFAULTS={inline:!1,button:!0,navbar:!0,title:!0,toolbar:!0,tooltip:!0,movable:!0,zoomable:!0,rotatable:!0,scalable:!0,transition:!0,fullscreen:!0,interval:5000,keyboard:!0,backdrop:!0,loading:!0,loop:!0,minWidth:200,minHeight:100,zoomRatio:0.1,minZoomRatio:0.01,maxZoomRatio:100,zIndex:2015,zIndexInline:0,url:'src',container:'body',filter:null,ready:null,show:null,shown:null,hide:null,hidden:null,view:null,viewed:null};
...
// var createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1;descriptor.configurable=!0;if("value" in descriptor)descriptor.writable=!0;Object.defineProperty(target,descriptor.key,descriptor)}}
...
// function isPlainObject(value){if(!isObject(value)){return!1}
// try{var _constructor=value.constructor;var prototype=_constructor.prototype;
//     return _constructor&&prototype&&hasOwnProperty.call(prototype,'isPrototypeOf')}catch(e){return!1}}
...
// this.showing=!0;this.open();var viewer=this.viewer;removeClass(viewer,CLASS_HIDE);
// if(options.transition&&!immediate){var shown=this.shown.bind(this);this.transitioning={abort:function abort(){removeListener(viewer,EVENT_TRANSITION_END,shown);removeClass(viewer,CLASS_IN)}};addClass(viewer,CLASS_TRANSITION);viewer.offsetWidth;addListener(viewer,EVENT_TRANSITION_END,shown,{once:!0});addClass(viewer,CLASS_IN)}
// else{addClass(viewer,CLASS_IN);
// this.shown()}
// return this},hide:function hide(){var immediate=arguments.length>0&&arguments[0]!==undefined?arguments[0]:!1;var element=this.element,options=this.options;
